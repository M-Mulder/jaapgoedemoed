...
export async function generateMetadata({
  ...
  return generateLocalizedMetadata({
    ...
    path: "artworks/composition-no-2-2022",
    title: "The Creation of Composition No. 2 (2022)",
    description:
      "Detailed process of creating the pentagonal Composition No. 2 artwork with matches by Jaap Goedemoed in 2022 — from concept to finished three-dimensional work.",
  });
}
