...
export default function HomeClient() {
  ...
  const homeContent = localeData.home;
  ...
  }, [currentArtworkIndex, changeArtwork]);
        ...
        {sliderImages.map((artwork, index) => (
          ...
          >
            ...
            <Image
              ...
              alt={`${artwork.title} by Jaap Goedemoed, ${artwork.year} - geometric abstract artwork`}
              fill
              priority={index === 0}
      ...
      <section className="py-24 bg-background relative overflow-hidden">
        ...
        <div className="container-wide relative z-10">
            ...
            {featuredWorks.map((artwork) => (
              ...
              >
                <div className="relative aspect-square">
                  <Image
                    src={artwork.imagePath}
                    alt={`${artwork.title} by Jaap Goedemoed, ${artwork.year} - ${artwork.medium}`}
                    fill
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    >
                      <span>{homeContent.featured.viewArtwork}</span>
                      <svg 
                        xmlns="http://www.w3.org/2000/svg" 
                    ...
                    >
                      {homeContent.featured.readStory}
                    </LocalizedLink>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-16 text-center">
            ...
            >
              <span>{homeContent.featured.viewCollection}</span>
              <svg 
                xmlns="http://www.w3.org/2000/svg" 
      ...
      <section className="py-24 bg-[#1a1a1a]">
        <div className="container-narrow">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="section-title mb-8">{homeContent.aboutTitle}</h2>
            {homeContent.aboutParagraphs.map((paragraph, index) => (
              <p key={index} className="text-lg text-text mb-6">
                {paragraph}
              </p>
            ))}
            <div className="mt-8">
              ...
              >
                <span>{homeContent.aboutLink}</span>
                <svg 
                  xmlns="http://www.w3.org/2000/svg" 
