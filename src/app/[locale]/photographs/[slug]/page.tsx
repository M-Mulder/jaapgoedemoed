...
export async function generateMetadata({
  ...
  const photograph = photographs.find((photo) => photo.slug === slug);

  if (!photograph) {
    return { title: 'Photograph Not Found' };
  }
  ...
  return generateLocalizedMetadata({
    ...
    description:
      ...
      `${photograph.title} — photograph by Jaap Goedemoed, ${photograph.year}`,
    image: photograph.imagePath ? `${baseUrl}${photograph.imagePath}` : undefined,
  });
}
