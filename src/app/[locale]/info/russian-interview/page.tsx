...
export async function generateMetadata({
  ...
  return generateLocalizedMetadata({
    ...
    path: "info/russian-interview",
    title: "Interview in Russian",
    description:
      "An interview in Russian with Jaap Goedemoed published on scripokiev.com, discussing his stock paper artworks, old bond certificates, and creative process.",
  });
}
